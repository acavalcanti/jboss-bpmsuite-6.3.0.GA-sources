...
public class UninstallerFrame extends JFrame
{
    ...
    /**
     * The quickstarts path, if it exists
     */
    protected String quickstartsPath;
    ...
    public UninstallerFrame(boolean displayForceOption, boolean forceOptionState) throws Exception
    {
        ...
        quickstartsPath = getQuickstartsPath();
    ...
    /**
     * Gets the quickstarts path from the log file.
     *
     * @throws Exception Description of the Exception
     */
    protected static String getQuickstartsPath()
    {
        try {
            InputStream in = UninstallerFrame.class.getResourceAsStream("/install.log");
            InputStreamReader inReader = new InputStreamReader(in, "UTF-8");
            ...
            reader.readLine();
            String retVal = "";
            if (reader.readLine().equals("installQuickStarts=true")){// lol
    ...
    class ActionsHandler implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            else if (src == destroyButton)
            {
				...
				if (quickstartsPath != null) {
					destroyer = new Destroyer(installPath, targetDestroyCheckbox.isSelected(), new DestroyerHandler(), quickstartsPath);
				} else {
					destroyer = new Destroyer(installPath, targetDestroyCheckbox.isSelected(), new DestroyerHandler());
				}
				destroyer.start();
            }
        }
