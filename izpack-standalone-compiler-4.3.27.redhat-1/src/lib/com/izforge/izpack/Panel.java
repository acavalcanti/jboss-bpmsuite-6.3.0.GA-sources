...
public class Panel implements Serializable
{
     ...
     */
    private List<String> validator = null;
    
    /**
     * Is the panel delayed? 
     */
    ...
    /**
     * Should the panel be in SummaryPanel
     * Defaults to true
     */
    ...
    public void setValidators(List<String> validator)
    {
    ...
    public void displayHidden(boolean displayHidden) { this.displayHidden = displayHidden;}
