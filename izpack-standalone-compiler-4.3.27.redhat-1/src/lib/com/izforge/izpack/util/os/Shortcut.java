...
public class Shortcut
{
    ...
    /**
     * indicates that this shortcut should not be created for the following operating systems
     */
    ...
    /**
     * Gets the excludeOs field
     *
     * @return Returns OSs that should be excluded
     */
    public String getExcludeOS(){
        return excludeOS;
    }

    /**
     * Sets the excludeOs field
     *
     * Sets OSs that should be excluded
     */
    public void setExcludeOS(String OSs){
        this.excludeOS = OSs;
    }
