        ...
        implements java.io.Serializable
{
     ...
     * @param release The release information froum from OsVersion.getOsDetails()
     */
     ...
     * @param version The exact OS version (check property <code>os.version</code> for values).
     * @param arch    The machine architecture (check property <code>os.arch</code> for values).
     * @param release The release information found from OsVersion.getOsDetails()
     */
    public OsConstraint(String family,
                        String name,
                        String version,
                        ...
                        String release)
    {
        this(family, name, version, arch, null, release);
    }    // end OsConstraint()
    ...
    public boolean matchCurrentSystem()
    {
        ...
        if(match && release != null && release.length() != 0)
        {
            if(OsVersion.getOsDetails() != null)
            {
                match = OsVersion.getOsDetails().toLowerCase().contains(release);
            }
        }
        ...
        return match
                && ((family != null) || (name != null) || (version != null) || (arch != null) || (jre != null) || release != null);
