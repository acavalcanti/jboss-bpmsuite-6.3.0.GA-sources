...
public class TwoColumnConstraints implements Cloneable
{
    ...
    /**
     * If this is set, the layout manager will attempt to place the components overtop of the most recently
     * added component. use with caution
     */
