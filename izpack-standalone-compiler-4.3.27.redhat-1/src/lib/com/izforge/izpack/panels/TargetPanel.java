...
public class TargetPanel extends PathInputPanel
{
    ...
    public static String loadDefaultDirFromVariables(Properties vars)
    {
        ...
        path = vars.getProperty("TargetPanel.dir.".concat(os));
    ...
    public TargetPanel(InstallerFrame parent, InstallData idata)
    {
         ...
         */
        pathSelectionPanel.getPathInputField().setActionCommand("Specify install path");
        AccessibleContext ac = pathSelectionPanel.getPathInputField().getAccessibleContext();
        ac.setAccessibleDescription("This JTextField contains the desired installation path");  
        pathSelectionPanel.getBrowseButton().setActionCommand("Browse filesystem");
        ac = pathSelectionPanel.getBrowseButton().getAccessibleContext();
        ac.setAccessibleDescription("JButton to browse the filesystem and specify installation path");
    ...
    public void panelActivate()
    {
        ...
        parent.setFocus(pathSelectionPanel);
    }
