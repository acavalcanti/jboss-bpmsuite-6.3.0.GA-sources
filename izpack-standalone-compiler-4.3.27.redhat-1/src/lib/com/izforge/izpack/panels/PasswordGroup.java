...
public class PasswordGroup implements ProcessingClient
{
    ...
    private HashMap<String, JPasswordField> namedFields = new HashMap<String, JPasswordField>();
...
//  private boolean hasParams = false;
    ...
    public void addNamedField(String id, JPasswordField field) {
        if (field != null && id != null) namedFields.put(id, field);
    }
    ...
    public String getNamedField(String id) {
        return new String(namedFields.get(id).getPassword());
    }
}
/*---------------------------------------------------------------------------*/
