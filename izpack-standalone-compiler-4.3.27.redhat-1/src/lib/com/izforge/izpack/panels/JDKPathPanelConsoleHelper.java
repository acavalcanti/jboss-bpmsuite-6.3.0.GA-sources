...
public class JDKPathPanelConsoleHelper extends PanelConsoleHelper implements PanelConsole
{
    ...
    private static final String PATH_SELECT     = "JDKPathPanel.info";
    ...
    public boolean runConsole(AutomatedInstallData idata, ConsoleInstaller parent)
    {
        ...
        while (bKeepAsking)
        {
            System.out.println(idata.langpack.getString(PATH_SELECT) +
                            " [" + strDefaultPath + "] ");
            Shell console = Shell.getInstance();
            System.out.println("GGetting location?");
